...
const Claim = ({ buyerName, taxNum, contractData, date, formType, increaseSumStatus, term, totalDebt, documents, selectedDocuments, penaltyRate, totalIncreaseSum, totalPenaltySum }) => {
