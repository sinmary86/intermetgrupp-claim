...
<p>Таким образом, неустойка по состоянию на текущую дату составляет {formatNumberWithSpaces(totalPenaltySum)} руб., при этом неустойка будет начисляться Поставщиком и подлежит оплате Покупателем по день фактического исполнения
обязательства по оплате задолженности в полном объеме. </p>
